...
两三年前的用户可能还记得 AutoHotkey Basic（关于各分支介绍请参阅[选择哪个分支？](http://zhuanlan.zhihu.com/autohotkey/19707355)）中自带有录制鼠标和键盘宏的工具——AutoScriptWriter：
...
更多功能请参阅帮助文档，[下一篇](http://jianshu.io/p/d9f8a6f281e2)将介绍 Pulover's Macro Creator 学习资源。
